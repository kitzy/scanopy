...
// ============================================================================
// Entity Tag Assignment Types and Handlers
// ============================================================================

/// Entity types that support tagging
const TAGGABLE_ENTITIES: &[EntityDiscriminants] = &[
...
fn validate_entity_type(entity_type: EntityDiscriminants) -> Result<(), ApiError> {
    if !TAGGABLE_ENTITIES.contains(&entity_type) {
        return Err(ApiError::bad_request(&format!(
            "Entity type '{}' does not support tags. Taggable types: {}",
            entity_type,
            TAGGABLE_ENTITIES
                .iter()
                .map(|e| e.to_string())
